    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl shadow-lg dark:bg-gray-800">
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>Convert text to speech directly in your browser</CardDescription>
            </div>
            <Button
              variant="outline"
              size="icon"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Slider value={[rate]} min={0.1} max={2} step={0.1} onValueChange={(value) => setRate(value[0])} />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Slider value={[pitch]} min={0.1} max={2} step={0.1} onValueChange={(value) => setPitch(value[0])} />
              </div>
            </div>
          </div>
        </CardContent>
        <CardFooter className="flex justify-center gap-2">
          ...
          <Button onClick={stop} variant="outline" className="w-32" disabled={!speaking && !paused}>
